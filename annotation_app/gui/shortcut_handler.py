...
class ShortcutHandler:
    ...
    def setup_shortcuts(self):
        ...
        next_image_shortcut.activated.connect(
            self.main_window.navigation_controller.next_image
        )

        # Previous image shortcut
        prev_image_shortcut = QShortcut(QKeySequence(Qt.Key_Left), self.main_window)
        prev_image_shortcut.activated.connect(
            self.main_window.navigation_controller.prev_image
        )
    ...
    def toggle_annotation_type(self):
        current_type = (
            self.main_window.annotation_controls.get_current_annotation_type()
        )
